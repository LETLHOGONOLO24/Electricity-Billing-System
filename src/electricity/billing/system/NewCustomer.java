...
public class NewCustomer extends JFrame implements ActionListener {
	...
	JTextField tfname, tfaddress, tfcity, tfProvince, tfemail, tfphone;
	JButton next, cancel;
	JLabel lblmeter;
	...
	NewCustomer()
	{
		...
		lblProvince.setBounds(100, 240, 100, 20);
		p.add(lblProvince);
		
		tfProvince = new JTextField();
		tfProvince.setBounds(240, 240, 200, 20);
		p.add(tfProvince);
	...
	public void actionPerformed(ActionEvent ae)
	{
		if (ae.getSource() == next)
		{
			...
			String query1 = "insert into customer(name, meter_no, address, city, province, email, phone) values('"+name+"', '"+meter+"', '"+address+"', '"+city+"', '"+province+"', '"+email+"', '"+phone+"')";
