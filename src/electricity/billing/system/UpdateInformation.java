...
public class UpdateInformation extends JFrame implements ActionListener {
	...
	JTextField tfaddress, tfcity, tfprovince, tfemail, tfphone;
	...
	UpdateInformation(String meter)
	{
		...
		lblProvince.setBounds(30, 230, 100, 20);
		add(lblProvince);
		
		tfprovince = new JTextField();
		tfprovince.setBounds(230, 230, 200, 20);
		add(tfprovince);
		
		JLabel lblemail = new JLabel("Email");
		lblemail.setBounds(30, 270, 130, 20);
		add(lblemail);
		...
		ImageIcon i1 = new ImageIcon("C:\\Users\\USER\\Documents\\eclipse-workspace\\Electricity Billing System\\src\\icons\\update.jpg");
