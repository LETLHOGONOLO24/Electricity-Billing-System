...
public class Signup extends JFrame implements ActionListener {
	...
	Signup()
	{
		...
		heading.setBounds(100, 50, 130, 20);
		...
		accountType.setBounds(235, 50, 150, 20);
		panel.add(accountType);
		
		JLabel lblmeter = new JLabel("Meter Number");
		lblmeter.setBounds(100, 90, 130, 20);
		...
		meter.setBounds(260, 125, 150, 20);
		meter.setVisible(false);
		add(meter);
		
		JLabel lblusername = new JLabel("Username");
		lblusername.setBounds(100, 130, 130, 20);
		lblusername.setForeground(Color.GRAY);
		lblusername.setFont(new Font("Tahoma", Font.BOLD, 14));
		panel.add(lblusername);
		
		username = new JTextField();
		username.setBounds(260, 165, 150, 20);
		add(username);
		
		JLabel lblname = new JLabel("Name");
		lblname.setBounds(100, 170, 130, 20);
		...
		lblpassword.setBounds(100, 210, 130, 20);
		...
		ImageIcon i1 = new ImageIcon("C:\\Users\\USER\\Documents\\eclipse-workspace\\Electricity Billing System\\src\\icons\\signupImage.png");
		Image i2 = i1.getImage().getScaledInstance(190, 230, Image.SCALE_DEFAULT);
